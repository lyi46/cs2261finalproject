...
#define BROWN      COLOR(20, 13, 10)  // Lighter brown
#define LIGHTBROWN COLOR(28, 22, 18) // Light skin tone
#define LIGHTGRAY  COLOR(24, 24, 24)
#define LIGHTBLUE  COLOR(15, 15, 31)
